...
fma_latency(data_type *n, unsigned long long *d_start, unsigned long long *d_end) {
    ...
    /// <--- /your code here --->
    // Chain 8 dependent FMA operations to measure sequential latency
    x = x * 2.0f + 1.0f;
    x = x * 2.0f + 1.0f;
    x = x * 2.0f + 1.0f;
    x = x * 2.0f + 1.0f;
...
__global__ void fma_latency_ilp(
    ...
    /// <--- /your code here --->
    // 8 FMA operations split across 2 independent variables (4 each)
    x = x * 2.0f + 1.0f;
    x = x * 2.0f + 1.0f;
    x = x * 2.0f + 1.0f;
    x = x * 2.0f + 1.0f;
...
__global__ void fma_latency_ilp2(
    ...
    /// <--- /your code here --->
    // 8 FMA operations across 8 independent variables (1 each) - maximum ILP
    x = x * 2.0f + 1.0f;
    y = y * 2.0f + 1.0f;
    a = a * 2.0f + 1.0f;
    b = b * 2.0f + 1.0f;
